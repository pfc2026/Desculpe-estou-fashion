...
if ($conn && $conn->connect_error) {
    // Se houver um erro de conexão, mostra a mensagem em vermelho.
    ...
    // Se a conexão foi bem-sucedida, mostra a mensagem em verde.
    ...
    // Caso muito raro onde a variável $conn nem foi criada.
